...
6. After changes to plan metadata or location, preview and apply synchronization, then check documentation links using [the documented commands](../../../docs/scripts/guide.md). Correct reported links in affected documents and rerun the checks. Never assume synchronization repairs those documents.
