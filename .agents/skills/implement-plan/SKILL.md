...
7. After progress or metadata changes, use [the documentation commands](../../../.agents/harness/scripts/guide.md) to synchronize plans and check links. Correct affected references without changing their meaning.
