...
6. Validate metadata and regenerate the type indexes with `sync-specifications.py`; check local links and repair reported references. Follow [the script commands](../../../docs/scripts/guide.md) for preview, apply, and read-only checks. Edit document frontmatter, not generated rows.
