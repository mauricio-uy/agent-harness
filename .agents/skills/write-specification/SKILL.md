...
4. Check consistency with related documents and verify referenced IDs. Apply the revision and replacement rules from the reference. Present the document's ID, type, revision, and pending decisions for human review; resolve blockers before setting `awaiting-approval`.
