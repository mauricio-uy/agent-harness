...
6. Use `sync-research.py` to validate research metadata and regenerate only the research index, then check links. Follow [the documentation commands](../../../.agents/harness/scripts/guide.md#synchronize-research) for preview, apply, and read-only checks. Edit source frontmatter rather than generated rows.
